...
class Gmap_ft extends EE_Fieldtype {
	...
	public function replace_tag($data, $params = array(), $tagdata = FALSE)
	{
		...
		if(isset($params['parse']))
		{
			...
			{
				$markers = $this->EE->google_maps->parse_geocoder_response(array($data->markers), $limit, $offset);
			...
			{
				$waypoints = $this->EE->google_maps->parse_geocoder_response(array($data->waypoints), $limit, $offset);
